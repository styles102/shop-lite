    ...
    public static async Task SeedAsync(ShopDbContext db)
    {
        ...
        db.Products.AddRange(
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/571-8/600/400",
                Stock = 150,
                Price = 19.99m,
                SalePrice = null,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/587-4/600/400",
                Stock = 80,
                Price = 49.99m,
                SalePrice = 34.99m,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/874-52/600/400",
                Stock = 200,
                Price = 29.99m,
                SalePrice = null,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/250-8/600/400",
                Stock = 60,
                Price = 89.99m,
                SalePrice = 69.99m,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/900-9/600/400",
                Stock = 120,
                Price = 14.99m,
                SalePrice = null,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/800-8/600/400",
                Stock = 45,
                Price = 79.99m,
                SalePrice = null,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/500-5/600/400",
                Stock = 300,
                Price = 24.99m,
                SalePrice = 18.99m,
            },
            new Product
            {
                ...
                ImageUrl = "https://picsum.photos/seed/600-6/600/400",
                Stock = 0,
                Price = 59.99m,
                SalePrice = null,
            }
